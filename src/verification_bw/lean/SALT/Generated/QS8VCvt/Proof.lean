...
private def neonLane (p : QS8CvtParams) (x : BitVec 8) : BitVec 8 :=
...
private def rvvLane (p : QS8CvtParams) (x : BitVec 8) : BitVec 8 :=
  let a := (p.input_zero_point - SALT.sext x 16).shiftLeft 7
...
private theorem lane_equal (p : QS8CvtParams) (x : BitVec 8)
