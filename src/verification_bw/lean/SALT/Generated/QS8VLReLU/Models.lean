...
def registrySha256 : String :=
  "fb3002cb82c443531d3af2285624b20f8316c50e45d222c1624b5fe21d85bf14"
...
-/
def neonPartialTailLivePrefixFromIntrinsics (p : QS8LReLUParams)
...
-/
def neonValueLoopWithOverreadFromIntrinsics (p : QS8LReLUParams)
...
def neonValueLoopFromIntrinsics (p : QS8LReLUParams)
    (input : List (BitVec 8)) : List (BitVec 8) :=
...
-/
def rvvValueLoopFromIntrinsics (p : QS8LReLUParams)
    (input : List (BitVec 8))
