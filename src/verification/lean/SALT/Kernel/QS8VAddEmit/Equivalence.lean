import SALT.Kernel.QS8VAddEmit.Neon
import SALT.Kernel.QS8VAddEmit.RVV
import SALT.Core.Tactic
import SALT.Kernel.Class
import SALT.Kernel.QS8.Params

namespace SALT.Kernel.QS8VAddEmit.Equivalence

open SALT
open SALT.Kernel.QS8VAddEmit.Neon
open SALT.Kernel.QS8VAddEmit.RVV
...
theorem qs8vaddemit_equiv (p : QS8AddMinmaxParams) (hwf : WellFormedParams p)
    (a b : List (BitVec 8))
...
end SALT.Kernel.QS8VAddEmit.Equivalence
