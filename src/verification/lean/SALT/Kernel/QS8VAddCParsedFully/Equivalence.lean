import SALT.Kernel.QS8VAddCParsedFully.Neon
import SALT.Kernel.QS8VAddCParsedFully.RVV
import SALT.Core.Tactic
import SALT.Kernel.Class
import SALT.Kernel.QS8.Params

namespace SALT.Kernel.QS8VAddCParsedFully.Equivalence

open SALT
open SALT.Kernel.QS8VAddCParsedFully.Neon
open SALT.Kernel.QS8VAddCParsedFully.RVV
...
theorem qs8vaddcparsedfully_equiv (p : QS8AddMinmaxParams) (hwf : WellFormedParams p)
    (input_b : BitVec 8)
    (x : List (BitVec 8))
...
end SALT.Kernel.QS8VAddCParsedFully.Equivalence
