import SALT.Kernel.QS8VAddCEmit.Neon
import SALT.Kernel.QS8VAddCEmit.RVV
import SALT.Core.Tactic
import SALT.Kernel.Class
import SALT.Kernel.QS8.Params

namespace SALT.Kernel.QS8VAddCEmit.Equivalence

open SALT
open SALT.Kernel.QS8VAddCEmit.Neon
open SALT.Kernel.QS8VAddCEmit.RVV
...
theorem qs8vaddcemit_equiv (p : QS8AddMinmaxParams) (hwf : WellFormedParams p)
    (input_b : BitVec 8)
    (x : List (BitVec 8))
...
end SALT.Kernel.QS8VAddCEmit.Equivalence
