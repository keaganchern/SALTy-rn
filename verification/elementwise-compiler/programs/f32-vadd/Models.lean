...
def programManifestSha256 : String := "5fa99c082f77b0769fa1539c27ecc13aa577ea17236b5ab3b9cd42813ee1d106"
def consumedEffectsSha256 : String := "a5dffbb45ed3707d9ef42c4a7669791c5ae7ce28ce6b3cb7b2c13a960f8b60e4"

def neonSourceSha256 : String :=
  "f7f8f8ffaca807aaa9839ba199fb93bac5cf79700c6c5d2f847731b0ab33eeb5"
def rvvSourceSha256 : String :=
  "6497d442136719b18ff5233adc6091a140c45973c84658431b7986f32acee593"
def neonPreprocessedSha256 : String :=
  "e3a30896c8e3e61a919dce0c12813174240064f8fcde04233101418ee070d4a5"
def rvvPreprocessedSha256 : String :=
  "5f03f602d539f3a6423b33eb33fed710c0eb408c1f391641e4518de7291437e7"
def parseFacadeSha256 : String :=
  "829b8b0358b2a31d50a784422681ac9e821a4369619812194f800dc63287c4bc"
def registrySha256 : String :=
  "35369074a4223b5386a77d928b04ed304886acb805bf3d8ac8aab4ecf094983c"

structure f32vaddParams where
  deriving Repr, DecidableEq

def neonBlock4FromIntrinsics (p : f32vaddParams)
    (input_a : List (BitVec 32))
    (input_b : List (BitVec 32)) : List (BitVec 32) :=
  let va_0 := (input_a).take 4
  let vb_0 := (input_b).take 4
  let vacc_0 := SALT.Intrinsics.Neon.vaddq_f32 (va_0) (vb_0)
  (vacc_0)
...
-/
def neonPartialTailLivePrefixFromIntrinsics (p : f32vaddParams)
    (loadedA loadedB : List (BitVec 32)) (live : Nat) : List (BitVec 32) :=
  let va_1 := (loadedA).take 4
  let vb_1 := (loadedB).take 4
  let vacc_1 := SALT.Intrinsics.Neon.vaddq_f32 (va_1) (vb_1)
...
-/
def neonValueLoopWithOverreadFromIntrinsics (p : f32vaddParams)
...
def neonValueLoopFromIntrinsics (p : f32vaddParams)
...
def rvvChunkFromIntrinsics (p : f32vaddParams)
    (input_a : List (BitVec 32))
    (input_b : List (BitVec 32)) : List (BitVec 32) :=
  let va_0 := input_a
  let vb_0 := input_b
  let vacc_0 := SALT.Intrinsics.RVV.vfadd_vv_f32 (va_0) (vb_0)
  vacc_0
...
-/
def rvvValueLoopFromIntrinsics (p : f32vaddParams)
    (input_a input_b : List (BitVec 32))
...
def fNeon (p : f32vaddParams) (x y : BitVec 32) : BitVec 32 :=
...
def fRvv (p : f32vaddParams) (x y : BitVec 32) : BitVec 32 :=
